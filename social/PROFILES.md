# Peak Carpenters — Social Profiles (copy/paste)
...
----------------------------------------
Facebook Page (fields to paste)
- Page name: Peak Carpenters
- Username: peakcarpenters (if available)
...
- Name: Peak Carpenters
- Handle: @peakcarpenters (or variant)
- Bio: Peak Carpenters — custom furniture & renovations in Durban. DM or email peakcarpenter538@gmail.com #furniture
- Location: Durban, South Africa
- Website: your site URL

----------------------------------------
Notes
- Use the same profile image across platforms for recognition (shop logo or a team photo from `img/`).
- Verify the email address on each platform and enable 2FA for security.
